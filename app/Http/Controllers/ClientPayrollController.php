        ...
        foreach ($data['employeePayroll'] as $key => $payroll) {
            if($payroll['days_of_work'] > 0) {
                $client_employee_payroll = \App\ClientEmployeePayroll::create([
                    ...
                    'days_of_work_rest_day' => $payroll['days_of_work_rest_day'],
                    ...
                    'night_pay_rest_day' => $payroll['night_pay_rest_day'],
                    ...
                    'hours_overtime_rest_day' => $payroll['hours_overtime_rest_day'],
